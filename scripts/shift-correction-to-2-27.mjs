// 6/3 자 보정 데이터를 2/27 로 일괄 이동
// - Transaction (description: '이월 매출 보정' 또는 '이월 매출 -')
// - ArPayment (notes: '[수동 보정]' 또는 '[이월]')
import { PrismaClient } from '@prisma/client'
const prisma = new PrismaClient()

const TARGET_DATE = new Date('2026-02-27T12:00:00')
const OLD_START = new Date('2026-06-03T00:00:00')
const OLD_END = new Date('2026-06-03T23:59:59')
...
console.log(`Transaction 날짜 이동 (6/3 → 2/27): ${tx.count}건`)
...
console.log(`ArPayment 날짜 이동 (6/3 → 2/27): ${pay.count}건`)
