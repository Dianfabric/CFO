...
- 거래처가 결정을 받아들이도록 정중하면서도 단호한 톤.`,
  HOLIDAY: `유형: 휴무 안내 공문.
- 인사 → 감사 → 휴무 안내 → 업무 제한 안내 → 양해 요청 → 하단 일정 안내 박스 순서.
- 본문 중간에는 날짜를 길게 반복하지 말고, 전달해야 하는 날짜는 맨 아래에 별도 섹션으로 분리.
- 마지막 하단 섹션은 반드시 "※ 일정 안내" 제목 아래 "■ 휴무기간 : ...", "■ 정상 업무 : ..." 형식으로 작성.
- 사용자가 입력한 휴무기간, 정상 업무 재개일, 긴급 연락처는 반드시 하단 일정 안내에 강하게 노출.
- 간결하고 명료한 톤.`,
...
4. 거래처 업무 일정에 차질이 없도록 아래 일정을 확인 부탁드립니다.
