...
- 거래처가 결정을 받아들이도록 정중하면서도 단호한 톤.`,
  HOLIDAY: `유형: 휴무 안내 공문.
- 인사 → 감사 → 휴무 안내 → 업무 제한 안내 → 양해 요청 → 하단 핵심 일정 박스 순서.
- 본문 중간에는 날짜를 길게 반복하지 말고, 전달해야 하는 핵심 날짜는 맨 아래에 별도 섹션으로 분리.
- 마지막 하단 섹션은 반드시 "※ 핵심 일정" 제목 아래 "■ 휴무기간 : ...", "■ 정상 업무 : ..." 형식으로 작성.
- 사용자가 입력한 휴무기간, 정상 업무 재개일, 긴급 연락처는 반드시 하단 핵심 일정에 강하게 노출.
- 간결하고 명료한 톤.`,
...
3. 당사의 휴무 일정으로 인해 해당 기간 동안 주문, 출고 및 상담 업무가 제한될 예정입니다.

4. 거래처 업무 일정에 차질이 없도록 아래 핵심 일정을 확인 부탁드립니다.

5. 정상 업무 재개 후 접수된 요청은 순차적으로 빠르게 처리하겠습니다.

6. 너른 양해를 부탁드리며, 항상 협조해 주셔서 감사합니다.
